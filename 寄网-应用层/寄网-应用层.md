...
![image-20221012101652816](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012101652816.png)
...
![image-20221012092450719](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012092450719.png)

D。客户机面向用户。其实主要注意C是对的

![image-20221012112533931](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012112533931.png)

![image-20221012112556726](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012112556726.png)
...
![image-20221005095507884](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221005095507884.png)
...
![image-20221012093347724](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012093347724.png)

对应的，邮件传输是带内控制。

> FTP客户首先连接服务器的21号端口，建立控制连接（控制连接在整个会话期间一直保持打开)，然后建立数据连接，在数据传送完毕后，数据连接最先释放，控制连接最后释放。

![image-20221012095753630](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012095753630.png)

![image-20221012095828837](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012095828837.png)
...
![image-20221012105830716](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012105830716.png)

##### TCP连接复用

虽然想法很朴素，但确解决了为追求简单和仅适应文本传输的历史遗留问题

![image-20221012110140184](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012110140184.png)

![image-20221012110329212](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012110329212.png)

##### 服务器推送和HTTP头压缩

当然服务器推送也增加了服务器的压力，因为之前服务器并不需要关注传输的是什么内容

![image-20221012110625529](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012110625529.png)

![image-20221012111205235](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221012111205235.png)

#### CDN

#### DASH

![image-20221019092551081](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221019092551081.png)

![image-20221019092718918](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221019092718918.png)

![image-20221019092804145](/Users/tianjiaye/Library/Application Support/typora-user-images//image-20221019092804145.png)
